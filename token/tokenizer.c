...
void add_token(TOKEN_T t, char *value, int line)
{
    ...
    strcpy(new_token->value, value ? value : NULL);
...
TOKEN *parse(char *code)
{
    ...
    while (!is_at_end(code, &c))
    {
        ...
        case '&':
            ...
            {
                parse_error("unknown symbol &. Did you mean && ?", line);
            }
        ...
        case '|':
            ...
            break;
        case '!':
            add_token(match(code, &c, '=') ? BANG_EQUAL : BANG, NULL, line);
        case '(':
        ...
        case '"':
            ...
            break;
        case '=':
            add_token(match(code, &c, '=') ? EQUAL_EQUAL : EQUAL, NULL, line);
            break;
        case '>':
            add_token(match(code, &c, '=') ? GREATER_EQ : GREATER, NULL, line);
            break;
        case '<':
            add_token(match(code, &c, '=') ? LESS_EQ : LESS, NULL, line);
            break;
        case '\n':
            line++;
            break;
